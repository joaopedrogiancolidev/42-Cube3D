...
/*   Updated: 2026/03/19 13:34:06 by arthur           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void raycast(void *param)
{
	...
	if (mlx_is_key_down(mlx, MLX_KEY_UP)) {
		if(cube_data->map[(int)cube_data->raycast.posY][(int)(cube_data->raycast.posX + cube_data->raycast.dirX * cube_data->raycast.moveSpeed)] == 0) cube_data->raycast.posX += cube_data->raycast.dirX * cube_data->raycast.moveSpeed;
		if(cube_data->map[(int)(cube_data->raycast.posY + cube_data->raycast.dirY * cube_data->raycast.moveSpeed)][(int)cube_data->raycast.posX] == 0) cube_data->raycast.posY += cube_data->raycast.dirY * cube_data->raycast.moveSpeed;
	}
	...
	if (mlx_is_key_down(mlx, MLX_KEY_RIGHT)) {
		...
		cube_data->raycast.dirX = cube_data->raycast.dirX * cos(-cube_data->raycast.moveSpeed) - cube_data->raycast.dirY * sin(-cube_data->raycast.moveSpeed);
		cube_data->raycast.dirY = cube_data->raycast.oldDirX * sin(-cube_data->raycast.moveSpeed) + cube_data->raycast.dirY * cos(-cube_data->raycast.moveSpeed);
		cube_data->raycast.oldPlaneX = cube_data->raycast.planeX;
		cube_data->raycast.planeX = cube_data->raycast.planeX * cos(-cube_data->raycast.moveSpeed) - cube_data->raycast.planeY * sin(-cube_data->raycast.moveSpeed);
		cube_data->raycast.planeY = cube_data->raycast.oldPlaneX * sin(-cube_data->raycast.moveSpeed) + cube_data->raycast.planeY * cos(-cube_data->raycast.moveSpeed);
	}
